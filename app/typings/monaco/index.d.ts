declare namespace monaco {
   ...
   */
    function createModel(value: string, language?: string, uri?: Uri): IModel

    /**
   * Change the language for a model.
   */
    function setModelLanguage(model: IModel, language: string): void
   ...
   */
    function getModel(uri: Uri): IModel

    /**
   * Get all the created models.
   */
    function getModels(): IModel[]

    /**
   * Emitted when a model is created.
   * @event
   */
    function onDidCreateModel(listener: (model: IModel) => void): IDisposable

    /**
   * Emitted right before a model is disposed.
   * @event
   */
    function onWillDisposeModel(listener: (model: IModel) => void): IDisposable
   ...
   * Define a new theme.
   */
    function defineTheme(themeName: string, themeData: ITheme): void
   ...
   */
     ...
     * It should a function `create` that should return the exported proxy.
     */
      moduleId: string
      /**
   ...
   */
    interface IEditorConstructionOptions
      extends ICodeEditorWidgetCreationOptions {
      /**
   ...
   */
    ...
    class InternalEditorMinimapOptions {
    ...
    class InternalEditorViewOptions {
    ...
    interface IViewConfigurationChangedEvent {
    ...
    interface IReadOnlyModel extends ITextModel {
      /**
     ...
     */
    interface ITokenizedModel extends ITextModel {
      /**
       * Get the language associated with this model.
       */
      getModeId(): string
     ...
     */
    interface ITextModelWithMarkers extends ITextModel {}
     ...
     */
    interface IEditableTextModel extends ITextModelWithMarkers {
      /**
    ...
    interface IModel
       ...
       */
      onDidChangeContent(
        listener: (e: IModelContentChangedEvent2) => void
      ): IDisposable
      /**
     ...
     */
    interface IModelContentChangedEvent2 {
      /**
     ...
     */
    interface ICodeEditorWidgetCreationOptions extends IEditorOptions {
      /**
     ...
     */
    interface ICodeEditorViewState extends IEditorViewState {
     ...
     */
    interface IDiffEditorModel extends IEditorModel {
      /**
       * Original model.
       */
      original: IModel
     ...
     */
    interface IDiffEditorViewState extends IEditorViewState {
   ...
   */
    ...
    interface ICommonCodeEditor extends IEditor {
      /**
    ...
    interface ICommonDiffEditor extends IEditor {
      /**
   ...
   */
    interface EditorScrollArguments {
      to: string
      by?: string
      value?: number
   ...
   */
     ...
     * A rich code editor.
     */
    interface ICodeEditor extends ICommonCodeEditor {
      /**
     ...
     * A rich diff editor.
     */
    interface IDiffEditor extends ICommonDiffEditor {
      /**
  ...
  namespace languages {
    ...
    interface IBracketElectricCharacterContribution {
    ...
    interface DefinitionProvider {
       ...
       * Open file
       */
      openFile?(fileName: String): Thenable<void>
    }
    ...
    interface DocumentFormattingEditProvider {
      ...
      provideDocumentFormattingEdits(
        ...
        token: CancellationToken
      ): editor.ISingleEditOperation[] | Thenable<editor.ISingleEditOperation[]>
    }
